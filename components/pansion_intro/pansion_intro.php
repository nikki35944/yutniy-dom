  ...
  <section class="pansion_intro block" id="pansion_intro">
    <div class="pansion_intro__inner block__inner">
      <div class="pansion_intro__left">
        <img loading="lazy" src="" alt="pansion" class="pansion_intro__main-image">

        <div class="pansion_intro__images-container owl-carousel">

          <?php foreach (get_field('pansion_intro__mini-image') as $photo => $value):
            if($value): ?>
              <a data-fslightbox="pansion_intro__mini-image" href="<?php echo $value?>"><img loading="lazy" class="pansion_intro__mini-image" src="<?php echo $value?>" alt="pansion"></a>
            <?php endif ?>
          <?php endforeach ?>
      ...
      <div class="pansion_intro__right">
        ...
        <ul class="pansion_intro__advantages">
          ...
          <?php
            ...
            for ($i=0; $i < 6; $i++):
              ...
              if($image != '') { echo ('<li class="pansion_intro__advantage"><img loading="lazy" src="' . $image . '" title="'. $adv_label_formatted .'" alt="advantages">' . $advantage['label'] . '</li>'); }
            endfor;
          ?>
